...
// Supabase client
const supabase = createClient('https://dodijnhzghlpgmdddklr.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRvZGlqbmh6Z2hscGdtZGRka2xyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM0NTE3MTksImV4cCI6MjA2OTAyNzcxOX0.soz1ofVIZ3NeWkcE1yUCIylFiVry5nwvc9PvHn7TZQQ');
    ...
    resources: {
        en: {
            translation: {
                ...
                support_placeholder: 'Drop your complaint, our 24/7 customer support team will respond immediately',
        ...
        fr: {
            translation: {
                welcome: 'Bienvenue à Diver Deposit Bank',
                since: 'Au service des clients depuis 1998',
                login: 'Connexion',
                username: 'Nom d’utilisateur',
                password: 'Mot de passe',
                security_code: 'Quel est votre code de sécurité ?',
                favorite_food: 'Quel est votre aliment préféré ?',
                support_contact: 'Contactez notre équipe de support client 24/7',
                ...
                withdraw: 'Retrait',
                transfer: 'Transfert',
                statement: 'Télécharger l’extrait',
                support: 'Support client',
                support_placeholder: 'Laissez votre plainte, notre équipe de support répondra immédiatement',
                loan: 'Demander un prêt',
                apply: 'Appliquer',
                broker: 'Courtier en investissement',
                crypto: 'Trading de cryptomonnaies',
                buy: 'Acheter',
                sell: 'Vendre',
                create: 'Créer un utilisateur',
                add: 'Ajouter une transaction',
                assign: 'Assigner un courtier',
                update: 'Mettre à jour le courtier',
                delete: 'Supprimer le courtier',
        ...
        es: {
            translation: {
                ...
                support_contact: 'Contacta a nuestro equipo de soporte al cliente 24/7',
